...
function BookDetails() {
  ...
  // ✅ FIXED: Correct API route /books/req-issue/:bookid
  async function issueBook(bookid) {
    try {
      ...
      const response = await axios.post(
        `${Server_URL}books/req-issue/${bookid}`,
        {},
        {
          headers: {
      ...
      // After issuing → Refresh Book details
      const updatedBook = await axios.get(`${Server_URL}books/${id}`);
      ...
      <div className="book-details">
        ...
        <div className="book-info">
          ...
          <div className="book-description">
            <h3>
              <FaInfoCircle className="description-icon" /> Description
            </h3>
          ...
          <div className="action-buttons">
            <motion.button
              className={`issue-button ${book.availableCopies <= 0 ? "disabled" : ""}`}
            ...
            >
              {isIssuing ? (
                ...
                <>
                  ...
                  {book.availableCopies <= 0 ? "Out of Stock" : "Issue This Book"}
                </>
              )}
            </motion.button>
          </div>
